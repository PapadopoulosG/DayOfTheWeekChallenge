...
//        Monday.. Saturday if the int parameter day is 0, 1,  ... 6 respectively,
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printDayOfTheWeek(-1);
        printDayOfTheWeekBonusSolution(95);
    ...
    private static void printDayOfTheWeekBonusSolution(int day) {
